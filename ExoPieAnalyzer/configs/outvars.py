...
df_out_SR_boosted = DataFrame(columns=['run', 'lumi', 'event', 'pu_nTrueInt','THINjetNPV','MET',
...
df_out_SBand_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets',
                                       'isak4JetBasedHemEvent', 'isak8JetBasedHemEvent',
...
df_out_Tope_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
...
df_out_Topmu_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets','Wmass',
...
df_out_We_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets','Wmass',
...
df_out_Wmu_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets','Wmass',
...
df_out_Zee_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
...
df_out_Zmumu_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','N2DDT', 'fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi',
...
df_out_TopWmu_boosted = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV', 'N2DDT','fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets','Wmass',
...
df_out_TopWe_boosted = DataFrame(columns=['run', 'lumi', 'event', 'pu_nTrueInt','THINjetNPV','MET','RECOIL',
                                       'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                       'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','N2DDT', 'fjetTau21','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi','isAK4jet1EtaMatch','isAK4jet2EtaMatch','M_Jet1AK8Jet','M_Jet2AK8Jet','Jet1CSV','Jet2CSV',
                                       'FJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                       'lep1_pT','lep1_eta','lep1_Phi','FJetN2b1','FJetN2b2','FJetrho','min_dphi_jets','Wmass',
...
df_out_Tope_resolved  = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL' ,
                                         'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                         'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                         'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
...
df_out_Topmu_resolved  = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL' ,
                                         'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                         'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                         'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                         'lep1_pT','lep1_eta','lep1_Phi','Wmass',
...
df_out_Wmu_resolved  = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL' ,
                                         'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                         'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                         'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                         'lep1_pT','lep1_eta','lep1_Phi','Wmass',
...
df_out_We_resolved  = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL' ,
                                         'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                         'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                         'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                         'lep1_pT','lep1_eta','lep1_Phi','Wmass',
...
df_out_Zee_resolved    = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL',
					'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                        'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                        'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                        'lep1_pT','lep1_eta','lep1_Phi',
...
df_out_Zmumu_resolved    = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','RECOIL',
                                        'Njets_PassID','Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                        'FJetPt', 'FJetEta', 'FJetPhi', 'FJetCSV','Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi',
                                        'DiJetMass', 'DiJetPt', 'DiJetEta','nJets','min_dPhi','met_Phi','RECOIL_Phi',
                                        'lep1_pT','lep1_eta','lep1_Phi',
...
df_out_SR_resolved = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt','THINjetNPV','MET','Njets_PassID',
                                       ...
                                       'DiJetMass','DiJetPt', 'DiJetEta','nJets','met_Phi',
                                       'isak4JetBasedHemEvent', 'isak8JetBasedHemEvent',
                                       'ismetphiBasedHemEvent1', 'ismetphiBasedHemEvent2',
                                       'weight','puweight','puweight_up','puweight_down','lepweight','lepweight_up','lepweight_down',
				       'METweight','METweight_up','METweight_down','METRes_up','METRes_down','METEn_up','METEn_down',
...
df_out_SBand_resolved = DataFrame(columns=['run', 'lumi', 'event','pu_nTrueInt', 'THINjetNPV','MET',
                                        'Njets_PassID', 'Nbjets_PassID', 'NTauJets', 'NEle', 'NMu', 'nPho','st_TopMatching',
                                        'Jet1Pt', 'Jet1Eta', 'Jet1Phi', 'Jet2Pt','Jet2Eta', 'Jet2Phi', 'Jet3Pt','Jet3Eta','Jet3Phi','Jet1CSV', 'Jet2CSV','Jet3CSV',
                                        'DiJetMass','DiJetPt', 'DiJetEta','nJets','met_Phi',
                                        'isak4JetBasedHemEvent', 'isak8JetBasedHemEvent',
