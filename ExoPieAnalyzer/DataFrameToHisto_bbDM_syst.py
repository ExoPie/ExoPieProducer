...
def HistWrtter(df, outfilename, treeName, mode="UPDATE"):
    ...
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        ...
        # Prefire Systematics
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightPrefire"], df["weightPrefire_up"],
                                "h_reg_" + reg + "_MET_weightPrefire_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightPrefire"], df["weightPrefire_down"],
                                "h_reg_" + reg + "_MET_weightPrefire_up", [200, 250, 350, 500, 1000]))
        ...
        if 'QCDCR' in reg:
            h_list.append(VarToHist(df["dPhi_jetMET"], df["weight"], df["weight"],
                                    df["weight"], "h_reg_" + reg + "_min_dPhi", [15, 0.0, 0.5]))
        else:
            h_list.append(VarToHist(df["dPhi_jetMET"], df["weight"], df["weight"],
        ...
        # Prefire Systematics
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightPrefire"], df["weightPrefire_up"],
                                "h_reg_" + reg + "_Recoil_weightPrefire_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightPrefire"], df["weightPrefire_down"],
                                "h_reg_" + reg + "_Recoil_weightPrefire_up", [200, 250, 350, 500, 1000]))
...
def emptyHistWritter(treeName, outfilename, mode="UPDATE"):
    ...
    if 'preselR' in treeName:
        ...
        reg = treeName.split('_')[1] + '_' + treeName.split('_')[2]
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        h_list.append(SetHist("h_reg_" + reg + "_MET",
        ...
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightEle_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightEle_down", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist("h_reg_" + reg + "_MET_weightMu_up",
                              [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightMu_down", [200, 250, 350, 500, 1000]))
        # pu WEIGHT SYSTEMATICS
        ...
        # Prefire Systematics
        h_list.append(SetHist("h_reg_" + reg +
                              "_MET_weightPrefire_down", [200, 250, 350, 500, 1000]))
        h_list.append(
        ...
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightEle_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightEle_down", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightMu_up", [200, 250, 350, 500, 1000]))
        h_list.append(
        ...
        h_list.append(SetHist("h_reg_" + reg +
                              "_Recoil_weightscale_down", [200, 250, 350, 500, 1000]))
        h_list.append(
        ...
        h_list.append(SetHist(
            "h_reg_" + reg + "_Recoil_weightPrefire_down", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist("h_reg_" + reg +
                              "_Recoil_weightPrefire_up", [200, 250, 350, 500, 1000]))
