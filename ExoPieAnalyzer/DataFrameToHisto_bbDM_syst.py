...
def HistWrtter(df, outfilename, treeName, mode="UPDATE"):
    ...
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"],          "h_reg_" + reg + "_MET_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleTrig"], df["weightEleTrig_down"],          "h_reg_" + reg + "_MET_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"],          "h_reg_" + reg + "_MET_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleTrig"], df["weightEleTrig_down"],          "h_reg_" + reg + "_MET_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleID"], df["weightEleID_up"],          "h_reg_" + reg + "_MET_weightEleID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleID"], df["weightEleID_down"],          "h_reg_" + reg + "_MET_weightEleID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleRECO"], df["weightEleRECO_up"],          "h_reg_" + reg + "_MET_weightEleRECO_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleRECO"], df["weightEleRECO_down"],          "h_reg_" + reg + "_MET_weightEleRECO_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMuID"], df["weightMuID_up"],          "h_reg_" + reg + "_MET_weightMuID_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMuID"], df["weightMuID_down"],          "h_reg_" + reg + "_MET_weightMuID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMuTRK"], df["weightMuTRK_up"],          "h_reg_" + reg + "_MET_weightMuID_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMuTRK"], df["weightMuTRK_down"],          "h_reg_" + reg + "_MET_weightMuTRK_down", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECAbsoluteUp'], "h_reg_" + reg + "_MET_weightJECAbsolute_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECAbsolute_yearUp'], "h_reg_" + reg + "_MET_weightJECAbsolute_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECBBEC1Up'], "h_reg_" + reg + "_MET_weightJECBBEC1_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECBBEC1_yearUp'], "h_reg_" + reg + "_MET_weightJECBBEC1_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECEC2Up'], "h_reg_" + reg + "_MET_weightJECEC2_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECEC2_yearUp'], "h_reg_" + reg + "_MET_weightJECEC2_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECFlavorQCDUp'], "h_reg_" + reg + "_MET_weightJECFlavorQCD_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECHFUp'], "h_reg_" + reg + "_MET_weightJECHF_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECHF_yearUp'], "h_reg_" + reg + "_MET_weightJECHF_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECRelativeBalUp'], "h_reg_" + reg + "_MET_weightJECRelativeBal_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECRelativeSample_yearUp'], "h_reg_" + reg + "_MET_weightJECRelativeSample_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECAbsoluteDown'], "h_reg_" + reg + "_MET_weightJECAbsolute_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECAbsolute_yearDown'], "h_reg_" + reg + "_MET_weightJECAbsolute_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECBBEC1Down'], "h_reg_" + reg + "_MET_weightJECBBEC1_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECBBEC1_yearDown'], "h_reg_" + reg + "_MET_weightJECBBEC1_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECEC2Down'], "h_reg_" + reg + "_MET_weightJECEC2_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECEC2_yearDown'], "h_reg_" + reg + "_MET_weightJECEC2_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECFlavorQCDDown'], "h_reg_" + reg + "_MET_weightJECFlavorQCD_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECHFDown'], "h_reg_" + reg + "_MET_weightJECHF_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECHF_yearDown'], "h_reg_" + reg + "_MET_weightJECHF_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECRelativeBalDown'], "h_reg_" + reg + "_MET_weightJECRelativeBal_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df['weightJECRelativeSample_yearDown'], "h_reg_" + reg + "_MET_weightJECRelativeSample_year_down", [200, 250, 350, 500, 1000]))
        # JER SYSTEMATICS
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df["weightscale_up"], "h_reg_" + reg + "_MET_weightscale_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df["weightscale_down"], "h_reg_" + reg + "_MET_weightscale_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df["weightpdf_up"], "h_reg_" + reg + "_MET_weightpdf_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightcentral"],  df["weightpdf_down"], "h_reg_" + reg + "_MET_weightpdf_down", [200, 250, 350, 500, 1000]))
        # Prefire Systematics
        ...
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"],          "h_reg_" + reg + "_Recoil_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleTrig"], df["weightEleTrig_down"],          "h_reg_" + reg + "_Recoil_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"],          "h_reg_" + reg + "_Recoil_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleTrig"], df["weightEleTrig_down"],          "h_reg_" + reg + "_Recoil_weightEleTrig_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleID"], df["weightEleID_up"],          "h_reg_" + reg + "_Recoil_weightEleID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleID"], df["weightEleID_down"],          "h_reg_" + reg + "_Recoil_weightEleID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleRECO"], df["weightEleRECO_up"],          "h_reg_" + reg + "_Recoil_weightEleRECO_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleRECO"], df["weightEleRECO_down"],          "h_reg_" + reg + "_Recoil_weightEleRECO_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightMuID"], df["weightMuID_up"],          "h_reg_" + reg + "_Recoil_weightMuID_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightMuID"], df["weightMuID_down"],          "h_reg_" + reg + "_Recoil_weightMuID_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightMuTRK"], df["weightMuTRK_up"],          "h_reg_" + reg + "_Recoil_weightMuID_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightMuTRK"], df["weightMuTRK_down"],          "h_reg_" + reg + "_Recoil_weightMuTRK_down", [200, 250, 350, 500, 1000]))
        # pu WEIGHT SYSTEMATICS
        ...
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECAbsoluteUp'], "h_reg_" + reg + "_Recoil_weightJECAbsolute_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECAbsolute_yearUp'], "h_reg_" + reg + "_Recoil_weightJECAbsolute_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECBBEC1Up'], "h_reg_" + reg + "_Recoil_weightJECBBEC1_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECBBEC1_yearUp'], "h_reg_" + reg + "_Recoil_weightJECBBEC1_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECEC2Up'], "h_reg_" + reg + "_Recoil_weightJECEC2_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECEC2_yearUp'], "h_reg_" + reg + "_Recoil_weightJECEC2_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECFlavorQCDUp'], "h_reg_" + reg + "_Recoil_weightJECFlavorQCD_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECHFUp'], "h_reg_" + reg + "_Recoil_weightJECHF_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECHF_yearUp'], "h_reg_" + reg + "_Recoil_weightJECHF_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECRelativeBalUp'], "h_reg_" + reg + "_Recoil_weightJECRelativeBal_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECRelativeSample_yearUp'], "h_reg_" + reg + "_Recoil_weightJECRelativeSample_year_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECAbsoluteDown'], "h_reg_" + reg + "_Recoil_weightJECAbsolute_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECAbsolute_yearDown'], "h_reg_" + reg + "_Recoil_weightJECAbsolute_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECBBEC1Down'], "h_reg_" + reg + "_Recoil_weightJECBBEC1_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECBBEC1_yearDown'], "h_reg_" + reg + "_Recoil_weightJECBBEC1_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECEC2Down'], "h_reg_" + reg + "_Recoil_weightJECEC2_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECEC2_yearDown'], "h_reg_" + reg + "_Recoil_weightJECEC2_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECFlavorQCDDown'], "h_reg_" + reg + "_Recoil_weightJECFlavorQCD_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECHFDown'], "h_reg_" + reg + "_Recoil_weightJECHF_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECHF_yearDown'], "h_reg_" + reg + "_Recoil_weightJECHF_year_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECRelativeBalDown'], "h_reg_" + reg + "_Recoil_weightJECRelativeBal_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df['weightJECRelativeSample_yearDown'], "h_reg_" + reg + "_Recoil_weightJECRelativeSample_year_down", [200, 250, 350, 500, 1000]))
        # JER SYSTEMATICS
        ...
        # pdf and scale systematics
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df["weightscale_up"], "h_reg_" + reg + "_Recoil_weightscale_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df["weightscale_down"], "h_reg_" + reg + "_Recoil_weightscale_down", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df["weightpdf_up"], "h_reg_" + reg + "_Recoil_weightpdf_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightcentral"],  df["weightpdf_down"], "h_reg_" + reg + "_Recoil_weightpdf_down", [200, 250, 350, 500, 1000]))
        # Prefire Systematics
...
def emptyHistWritter(treeName, outfilename, mode="UPDATE"):
    ...
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        ...
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightB_down", [200, 250, 350, 500, 1000]))
        # EWK SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightEWK_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightEWK_down", [200, 250, 350, 500, 1000]))
        # Top pT REWEIGHTING
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightTop_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightTop_down", [200, 250, 350, 500, 1000]))
        # MET Trigger SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightMET_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightMET_down", [200, 250, 350, 500, 1000]))
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleRECO_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleRECO_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightMuID_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightMuID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightMuID_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightMuTRK_down"[200,250,350,500,1000]))
        # pu WEIGHT SYSTEMATICS
        h_list.append(SetHist("h_reg_" + reg + "_MET_weightPU_up",[200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightPU_down", [200, 250, 350, 500, 1000]))
        # weightJEC SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightJEC_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightJEC_down", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECAbsolute_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECAbsolute_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECBBEC1_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECBBEC1_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECEC2_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECEC2_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECFlavorQCD_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECHF_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECHF_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECRelativeBal_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECRelativeSample_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECAbsolute_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECAbsolute_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECBBEC1_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECBBEC1_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECEC2_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECEC2_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECFlavorQCD_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECHF_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECHF_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECRelativeBal_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_MET_weightJECRelativeSample_year_down',[200,250,350,500,1000]))
        # JER SYSTEMATICS
        ...
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightscale_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightscale_down", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightpdf_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightpdf_down", [200, 250, 350, 500, 1000]))

        # Prefire Systematics
        h_list.append(SetHist("h_reg_" + reg +"_MET_weightPrefire_down", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_MET_weightPrefire_up", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(
            SetHist("h_reg_" + reg + "_pfpatCaloMETPt", [30, 0, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_pfpatCaloMETPhi", [15, -3.14, 3.14]))
        h_list.append(SetHist("h_reg_" + reg + "_pfTRKMETPt", [30, 0, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_pfTRKMETPhi", [15, -3.14, 3.14]))
        ...
        h_list.append(
            SetHist("h_reg_" + reg + "_Jet1NMultiplicity", [15, 0, 50]))
        if 'QCDCR' in reg:
            h_list.append(
                SetHist("h_reg_" + reg + "_min_dPhi", [15, 0.0, 0.5]))
        else:
            h_list.append(
                SetHist("h_reg_" + reg + "_min_dPhi", [15, 0.5, 3.2]))
        h_list.append(
            SetHist("h_reg_" + reg + "_dPhiTrk_pfMET", [15, -3.2, 3.2]))
        h_list.append(
            SetHist("h_reg_" + reg + "_dPhiCalo_pfMET", [15, -3.2, 3.2]))
        ...
        if ('SR_1b' in reg):
            h_list.append(
                SetHist("h_reg_" + reg + "_isjet1EtaMatch", [3, -1, 1]))
            h_list.append(
                SetHist("h_reg_" + reg + "_M_Jet1Jet2", [100, 0, 2000]))
        elif ('SR_2b' in reg):
            h_list.append(
                SetHist("h_reg_" + reg + "_isjet2EtaMatch", [3, -1, 1]))
            h_list.append(
                SetHist("h_reg_" + reg + "_M_Jet1Jet3", [100, 0, 2000]))
        elif ('preselR' in reg):
            h_list.append(
                SetHist("h_reg_" + reg + "_isjet1EtaMatch", [3, -1, 1]))
            h_list.append(
        ...
        # btag SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightB_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightB_down", [200, 250, 350, 500, 1000]))
        # EWK SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightEWK_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightEWK_down", [200, 250, 350, 500, 1000]))
        # Top pT REWEIGHTING
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightTop_up", [200, 250, 350, 500, 1000]))
        h_list.append(
        ...
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleRECO_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleRECO_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightMuID_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightMuID_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightMuID_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightMuTRK_down"[200,250,350,500,1000]))

        # pu WEIGHT SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightPU_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightPU_down", [200, 250, 350, 500, 1000]))
        # weightJEC SYSTEMATICS
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightJEC_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightJEC_down", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECAbsolute_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECAbsolute_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECBBEC1_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECBBEC1_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECEC2_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECEC2_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECFlavorQCD_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECHF_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECHF_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECRelativeBal_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECRelativeSample_year_up',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECAbsolute_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECAbsolute_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECBBEC1_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECBBEC1_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECEC2_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECEC2_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECFlavorQCD_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECHF_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECHF_year_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECRelativeBal_down',[200,250,350,500,1000]))
        h_list.append(SetHist('h_reg_'+reg+'_Recoil_weightJECRelativeSample_year_down',[200,250,350,500,1000]))
        # JER SYSTEMATICS
        ...
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightscale_up", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist("h_reg_" + reg +"_Recoil_weightscale_down", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightpdf_up", [200, 250, 350, 500, 1000]))
        h_list.append(
            SetHist("h_reg_" + reg + "_Recoil_weightpdf_down", [200, 250, 350, 500, 1000]))
        # Prefire Systematics
        h_list.append(SetHist(
            "h_reg_" + reg + "_Recoil_weightPrefire_down", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(SetHist("h_reg_" + reg + "_METPhi", [15, -3.14, 3.14]))
        h_list.append(
            SetHist("h_reg_" + reg + "_RecoilPhi", [15, -3.14, 3.14]))
        # mini_dPhi)
        ...
        if 'Zmumu' in reg or 'Zee' in reg:
            ...
            h_list.append(
                SetHist("h_reg_" + reg + "_lep2_eta", [30, -2.5, 2.5]))
            h_list.append(
                SetHist("h_reg_" + reg + "_lep2_Phi", [30, -3.14, 3.14]))
        if ('WmunuCR_1b' not in reg) and ('WenuCR_1b' not in reg):
            h_list.append(
                SetHist("h_reg_" + reg + "_ratioPtJet21", [20, 0, 1]))
            h_list.append(SetHist("h_reg_" + reg + "_dPhiJet12", [15, -8, 8]))
            h_list.append(SetHist("h_reg_" + reg + "_dEtaJet12", [15, -8, 8]))
        if ('1b' in reg) and ('WmunuCR_1b' not in reg) and ('WenuCR_1b' not in reg):
            h_list.append(
...
trees = ['bbDM_preselR', 'bbDM_SR_1b', 'bbDM_SR_2b', 'bbDM_ZeeCR_1b', 'bbDM_ZeeCR_2b', 'bbDM_ZmumuCR_1b', 'bbDM_ZmumuCR_2b', 'bbDM_WenuCR_1b', 'bbDM_WenuCR_2b',
         'bbDM_WmunuCR_1b', 'bbDM_WmunuCR_2b', 'bbDM_TopenuCR_1b', 'bbDM_TopenuCR_2b', 'bbDM_TopmunuCR_1b', 'bbDM_TopmunuCR_2b', 'bbDM_QCDCR_1b', 'bbDM_QCDCR_2b']
