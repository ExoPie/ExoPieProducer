...
def HistWrtter(df, outfilename, treeName, mode="UPDATE"):
    ...
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMETtrig"], df["weightMETtrig_up"],  "h_reg_" + reg + "_MET_weightMETtrig_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMETtrig"], df["weightMETtrig_down"],  "h_reg_" + reg + "_MET_weightMETtrig_down", [200, 250, 350, 500, 1000]))
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"], "h_reg_" + reg + "_MET_weightEleTrig_up", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightEleID"], df["weightEleID_up"], "h_reg_" + reg + "_MET_weightEleID_up", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(VarToHist(df["MET"], df["weight"], df["weightMuTRK"], df["weightMuTRK_up"], "h_reg_" + reg + "_MET_weightMuTRK_up", [200, 250, 350, 500, 1000]))
        ...
        # MET Trigger SYSTEMATICS
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightRecoiltrig"], df["weightRecoiltrig_up"],  "h_reg_" + reg + "_Recoil_weightRecoiltrig_up", [200, 250, 350, 500, 1000]))
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightRecoiltrig"], df["weightRecoiltrig_down"],  "h_reg_" + reg + "_Recoil_weightRecoiltrig_down", [200, 250, 350, 500, 1000]))
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleTrig"], df["weightEleTrig_up"], "h_reg_" + reg + "_Recoil_weightEleTrig_up", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightEleID"], df["weightEleID_up"], "h_reg_" + reg + "_Recoil_weightEleID_up", [200, 250, 350, 500, 1000]))
        ...
        h_list.append(VarToHist(df["Recoil"], df["weight"], df["weightMuTRK"], df["weightMuTRK_up"], "h_reg_" + reg + "_Recoil_weightMuTRK_up", [200, 250, 350, 500, 1000]))
...
def emptyHistWritter(treeName, outfilename, mode="UPDATE"):
    ...
    if ('SR' in reg) or ('preselR' in reg) or ('QCDCR' in reg):
        ...
        # MET Trigger SYSTEMATICS
        h_list.append(SetHist("h_reg_" + reg + "_MET_weightMETtrig_up", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist("h_reg_" + reg + "_MET_weightMETtrig_down", [200, 250, 350, 500, 1000]))
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightEleID_up"[200,250,350,500,1000]))
        ...
        h_list.append(SetHist("h_reg_"+reg+"_MET_weightMuTRK_up"[200,250,350,500,1000]))
        ...
        # MET Trigger SYSTEMATICS
        h_list.append(SetHist("h_reg_" + reg + "_Recoil_weightRecoiltrig_up", [200, 250, 350, 500, 1000]))
        h_list.append(SetHist("h_reg_" + reg + "_Recoil_weightRecoiltrig_down", [200, 250, 350, 500, 1000]))
        # LEPTON WEIGHT SYSTEMATICS
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_up"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleTrig_down"[200,250,350,500,1000]))
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightEleID_up"[200,250,350,500,1000]))
        ...
        h_list.append(SetHist("h_reg_"+reg+"_Recoil_weightMuTRK_up"[200,250,350,500,1000]))
