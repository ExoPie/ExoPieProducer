#!/usr/bin/env python
# coding: utf-8
##Usage: python crSummary_postfit.py -i inputRootFile/fitDiagnostics_2b_20161718_fit_CRonly_result_checkscombo20161718.root -d b -c 2b -t fitDiagnostics_2b_20161718_fit_CRonly_result_checkscombo2016 -y 2018
import os
import sys
import ROOT as ROOT
import optparse
...
rtFile = ROOT.TFile('outPlotDir/'+tag+"/postfit_Summary_"+year+"_"+cat+".root", 'RECREATE')
