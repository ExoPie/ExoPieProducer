...
def makeplot(loc, hist, titleX, XMIN, XMAX, Rebin, ISLOG, NORATIOPLOT, reg, varBin, row=2):
    ...
    for file in files.readlines()[:]:
        ...
        if 'WJetsToLNu_HT' in file or 'W1JetsToLNu' in file or 'W2JetsToLNu' in file or 'WJetsToLNu_Pt' in file:
    ...
    if makeMuCHplots:
        ...
        noYieldHisto = bool(('weight' in hist) or ('_up' in hist)
                            or ('_down' in hist))
    if makeSIGplots:
        if ('_'+limit_varSR in hist) and ('SR' in hist) and not noYieldHisto:
